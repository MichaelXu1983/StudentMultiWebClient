          ...
          children: [
            {
              type: 'text',
              text:
                '这是我们经常被问到的一个问题 - 而且没有一个明确的答案。这取决于你已经知道的，以及为什么你想要了解更多！如果您以前从未尝试过编码，请先使用拖放操作来学习概念。如果你之前尝试过拖放编程并想尝试基于文本的编码，那么最广泛使用的编程语言就是JavaScript。如果您想构建特定的内容，例如Android应用，iOS应用，网站或数据库，则每种内容都有特定的语言。',
            },
          ],
        },
      ]
  ...
  render() {
    return (
      <View className='article-detail'>
        <RichText className='article-detail__richtext' nodes={this.state.helpDetailNodes} />
      </View>
    )
  }
}
