            ...
            <View className={styles['help']}>
                ...
                <View className={styles['help-link__item']}>
                    <View className={styles['help-link__icon']}>
                        <Image src={help_guide} className={styles['help-link__icon-help']} />
                    </View>
                    <View className={styles['help-link__ask']}>
                        ...
                        <Navigator url='/pages/webview/guide' className={styles['index__Navigator']}>
                            <View className={styles['help-link__title help-link__title-noborder']}>
                                <Text className={styles['help-link__title-text']}>上课指南 ？</Text>
                            </View>
                        </Navigator>
                    </View>
                </View>
                ...
                <View className={styles['help-link__item']}>
                    <View className={styles['help-link__icon']}>
                        <Image src={help_update} className={styles['help-link__icon-help']} />
                    </View>
                    <View className={styles['help-link__ask']}>
                        <Navigator url='/pages/webview/update_time' className={styles['index__Navigator']}>
                            <View className={styles['help-link__title']}>
                                <Text className={styles['help-link__title-text']}>
                                    我们多长时间更新一次课程 ？
                </Text></View>
                        </Navigator>
                        <Navigator url='/pages/webview/update_notice' className={styles['index__Navigator']}>
                            <View className={styles['help-link__title']}>
                                <Text className={styles['help-link__title-text']}>
                                    如何收到课程更新通知 ？
                </Text>
