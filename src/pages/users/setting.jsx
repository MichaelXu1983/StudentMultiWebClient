...
class Setting extends Component {
  ...
  componentDidMount() {
    httpRequest.get("/api/v1/contents/1/176").then((r) => {
      this.setState({
        list: r.data.value,
      });
    });
        ...
        <View className={styles["setting-link"]}>
          ...
          {list.map((item) => (
            ...
            >
              <View className={styles["setting-link__item"]}>
                <View className={styles["setting-link__title"]}>
                  <Text className={styles["setting-link__title-text"]}>
                    {item.title}
                  </Text>
                </View>
                <View className={styles["setting-link__arrow"]}>
                  <Image
                    src={arrowRight}
                    className={styles["setting-link__arrow--active"]}
                  />
                </View>
              </View>
            </Navigator>
          ...
          {/* <Navigator
            url="/pages/webview/about_detail"
            className={styles["index__Navigator"]}
          >
            <View className={styles["setting-link__item"]}>
              <View className={styles["setting-link__title"]}>
              ...
              <View className={styles["setting-link__extra"]}>
                <Text className={styles["setting-link__extra-text"]}>
          ...
          <Navigator
            url="/pages/webview/agreement_detail"
            className={styles["index__Navigator"]}
          >
            <View className={styles["setting-link__item"]}>
              <View className={styles["setting-link__title"]}>
          ...
          <Navigator
            url="/pages/webview/privacy_detail"
            className={styles["index__Navigator"]}
          >
            <View className={styles["setting-link__item"]}>
              <View className={styles["setting-link__title"]}>
